window.onload = function() {
   ...
   //eventos de los btns 
    ...
    function desplegarMenu(){
        ...
        btnMenu.style.display = "none";        cerrarMenuBtn.style.display = "block";
    ...
    //esta gunccion cerrara el menu a
     function cerrarMenu() {
         ...
         btnMenu.style.display = "block";        cerrarMenuBtn.style.display = "none";
         elem.style.display = " flex";               menuList.classList.remove("menu_list_actived");
     }
   ...
   /* foco(boxUno,"boxUno");
    foco(boxDos,"boxDos");
    foco(boxTres,"boxTres");
    foco(boxCuatro,"boxCuatro");
    foco(boxCinco,"boxCinco");
    foco(boxSeis,"boxSeis");*/
    
    
    /* definire funciones Para los botones del menu */
